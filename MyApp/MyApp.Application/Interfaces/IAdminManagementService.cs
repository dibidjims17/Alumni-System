...
namespace MyApp.Application.Interfaces
{
    public interface IAdminManagementService
    {
        ...
        Task<(bool Success, string? RelativePath, string Message)> UpdateAdminPictureAsync(int adminId, string relativePath, string physicalPath, int requestingAdminId);
    }
}