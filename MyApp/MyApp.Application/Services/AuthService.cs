...
namespace MyApp.Application.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<MyApp.Domain.Entities.Student?> DebugResetPasswordAsync(string studentNumber)
        {
            var student = await _studentRepository.GetByStudentNumberAsync(studentNumber);
            if (student == null)
                return null;

            student.PasswordHash = BCrypt.Net.BCrypt.HashPassword(studentNumber);
